...
@Service
public class EmployeesService_photo {
    ...
    @Autowired
    public EmployeesService_photo(EmployeesRepository employeesRepository, EmployeesSkillRepository employeesSkillRepository, SkillsRepository skillsRepository) {
